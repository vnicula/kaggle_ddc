...
class MesoInception5():
    ...
    def init_model(self):
        ...
        # y = LeakyReLU(alpha=0.1)(y)
        # y = Dropout(0.5)(y)
        y = Dense(1, activation = None, kernel_regularizer=tf.keras.regularizers.l2(0.02))(y)
...
def resnet_18(input_shape, num_filters=64):
    ...
    X = tf.keras.layers.Dense(units=1, activation=None, kernel_regularizer=tf.keras.regularizers.l2(0.02))(X)
...
class OneMIL():
    ...
    def create_model(self):
        ...
        # left_up_input = tf.image.resize_with_pad(left_up_input, self.input_shape[0], self.input_shape[1])
